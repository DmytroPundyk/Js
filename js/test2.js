...
const indexPriority = (priority) => Object.values(PRIORITY).indexOf(priority);
const sortArrey = (array) => [...array].sort((a, b) => a.id - b.id)
   .sort((a, b) => indexPriority(a.priority) - indexPriority(b.priority));



console.log(sortArrey(array))